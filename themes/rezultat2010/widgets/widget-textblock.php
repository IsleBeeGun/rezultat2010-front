 ...
 */
class TextBlock_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'textblock_widget', // Base ID
			esc_html__( 'Результат2010 - Блок текста', 'text_domain' ), // Name
			array( 'description' => esc_html__( 'Обычный блок текста с заголовком', 'text_domain' ), ) // Args
		);
	}
